...
class JsonDiff {
  constructor (options) {
    options.looseComparison = !!options.looseComparison
  ...
  diff (obj1, obj2) {
    ...
    if (!this.options.keysOnly) {
      if (type1 === 'date' && type2 === 'date') {
        ...
        } else if (this.options.looseComparison && (
          (type1 === 'string' && type2 === 'number') ||
          (type1 === 'number' && type2 === 'string') ||
          (type1 === 'boolean' && type2 === 'number') ||
          (type1 === 'number' && type2 === 'boolean') ||
          (type1 === 'null' && type2 === 'boolean') ||
          (type1 === 'boolean' && type2 === 'null') ||
          (type1 === 'null' && type2 === 'string') ||
          (type1 === 'string' && type2 === 'null')
        )) {
        equal = Number(obj1) === Number(obj2)
      } else {
        equal = obj1 === obj2
      }
      if (!equal) {
